...
extension Snapshotting where Value == NSView, Format == NSImage {
  ...
  public static func image(precision: Float = 1, strategy: ImageDiffingStrategy = .perImage, size: CGSize? = nil) -> Snapshotting {
    return SimplySnapshotting.image(precision: precision, strategy: strategy).asyncPullback { view in
